...
public class SudokuResueltoLento extends javax.swing.JDialog {
    
    private int [][] sudoku;
    private int tiempo;
    private int anotaciones = 0;
    private int anotacionesActuales = 0;
    private boolean fin = false;
   
    public SudokuResueltoLento(java.awt.Frame parent, boolean modal, int[][] sudoku) {
        super(parent, modal);
        initComponents();
        this.sudoku = sudoku;
        ponerNegrita(sudoku);
        Object velocidad;
        do {
            velocidad = JOptionPane.showInputDialog(
                    this,
    ...
    private void inicio() {
        ...
        new Thread() {
            public void run() {
                ...
                sudokuAux = copiarMatriz (sudoku, sudokuAux);
                contarAnotaciones(exito, f, c); //se cambia el suduko, por tanto hay que dejarlo como estaba
                exito.setValor(false);
                sudoku = copiarMatriz (sudokuAux, sudoku);
                resolverSudoku(exito, f, c);

                SwingUtilities.invokeLater(new Runnable() { //cuando acabe se hará esto
                    public void run() {
                        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Sudoku resuelto", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 16)));
    ...
    private void resolverSudoku (Booleano exito, int fila, int columna){
        ...
        do {
            if (candidatoAceptable(candidato,fila,columna)){
                ...
                mostrarResultado();
                anotacionesActuales++;
                float f = (float)anotacionesActuales/anotaciones*100;
                ...
                try {
                    if (tiempo > 0)
                     ...
                     JOptionPane.showMessageDialog(null, "Se ha producido un error resolviendo el sudoku dinámicamente", "Error", JOptionPane.ERROR_MESSAGE);
                }
            ...
            candidato++;
        }while (!exito.getValor() && candidato<=9 && !fin);
    }
    ...
    private void contarAnotaciones (Booleano exito, int fila, int columna){
        int candidato = 1;
        int columnaAux, filaAux;
        ...
        do {
            if (candidatoAceptable(candidato,fila,columna)){
                ...
                if (esSolucion()){
                    ...
                    //Probamos en la siguiente celda si está libre (esto siempre ocurrirá menos si estamos en la útima celda y está ocupada)
                    if(sudoku[filaAux][columnaAux]==0)
                        contarAnotaciones(exito,filaAux,columnaAux);
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Resolviendo sudoku...", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 16))); // NOI18N
        ...
        tick.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resolucionsudoku/Tick.png"))); // NOI18N
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(botonVolver, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(jProgressBar1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 26, Short.MAX_VALUE)))
                .addContainerGap())
        );
